import sys
sys.path.insert(0, '/home/samiran/TRI/Pipeline')
...
model = create_model()
model.load_weights("Pipeline/new_traffic_light_weights.h5")
...
for i in Test.keys():
    ...
    total_time, original_image,heatmap,thresh,final_annotated_image=run_pipeline(i,Test[i],ids,model_heatmap,model)
